$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Richter and Ellalyne's Wedding",

            // Event start date
            start: new Date('June 26, 2022 15:00'),

            // You can also choose to set an end time
            // If an end time is set, this will take precedence over duration
            end: new Date('June 26, 2022 21:00'),

            // Event Address
            address: 'San Agustin Church, Manila',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbzwsgNwrbUba5wUppbAnXMLgG6sjlqmUEQ5gymme5zGN00KkjIEsn9QV6oVPAwwPVXJQw/exec', data)
            .done(function (data) {
                console.log(data);
